...
window.onload = function() {
    setTimeout(function() {
        const enlace = document.querySelector('.enlace-flex');
        enlace.style.display = 'flex'; /* Cambia el display a flex para hacerlo visible */
    }, 15000); // Espera 15 segundos (15000 milisegundos) antes de mostrar el contenido
};
